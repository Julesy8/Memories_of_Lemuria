...
outlaw = AIActor(
    ...
    bodyparts=(Head(hp=20, protection_ballistic=0, protection_physical=0, depth=20, width=20, height=26),
               Body(hp=60, protection_ballistic=0, protection_physical=1, depth=20, width=35, height=56),
...
peacekeeper = AIActor(
    ...
    fighter=GunFighter(unarmed_meat_damage=10, unarmed_armour_damage=1, ranged_accuracy=1.4),
    ai=HostileEnemyArmed,
    bodyparts=(Head(hp=20, protection_ballistic=0.16, protection_physical=2, depth=20, width=20, height=26),
               Body(hp=60, protection_ballistic=0.2, protection_physical=2, depth=20, width=35, height=56),
               Arm(hp=30, protection_ballistic=0, protection_physical=1,
                   name='right arm', depth=10, width=10, height=78),
               Arm(hp=30, protection_ballistic=0, protection_physical=1,
                   name='left arm', depth=10, width=10, height=78),
...
troglodyte = AIActor(
    ...
    ai=HostileEnemy,
    bodyparts=(Head(hp=10, protection_ballistic=0, protection_physical=0, depth=20, width=20, height=18),
...
soldier = AIActor(
    ...
    ai=HostileEnemyArmed,
    bodyparts=(Head(hp=20, protection_ballistic=0.2, protection_physical=3, depth=20, width=20, height=26),
