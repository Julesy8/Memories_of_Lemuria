...
class Humanoid(Entity):  # humanoid body class
    def __init__(self, head_hp, torso_hp, limbs_hp, head_def, torso_def, arms_def, legs_def,
                 x, y, char, fg_colour, bg_colour, name, blocks_movement=True, fighter=None, ai=None):
        ...
        super().__init__(x, y, char, fg_colour, bg_colour, name, blocks_movement=blocks_movement, fighter=fighter, ai=ai)
