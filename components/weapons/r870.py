...
r870_barrel_26 = Item(
    ...
    usable_properties=GunComponent(part_type='Model 870 Barrel',
                                   ...
                                   velocity_modifier={'12 Guage': 1.0, 'single projectile': 1.0, 'buckshot': 1.0},
...
r870_barrel_18 = Item(
    ...
    usable_properties=GunComponent(part_type='Model 870 Barrel',
                                   incompatibilities=(("Iron Sight",),),
                                   velocity_modifier={'12 Guage': 1.0, 'single projectile': 0.96, 'buckshot': 0.97},
                                   is_attachment_point_types=['Remington 12 Ga Choke', ],
                                   optic_properties={'target_acquisition_ap': 0.95,
                                                     'ap_distance_cost_modifier': 1.2,
                                                     'spread_modifier': 1.1, },
...
r870_barrel_t14 = Item(
    ...
    usable_properties=GunComponent(part_type='Model 870 Barrel',
                                   suffix='TAC-14',
                                   incompatibilities=(("Iron Sight",),),
                                   velocity_modifier={'12 Guage': 1.0, 'single projectile': 0.9, 'buckshot': 0.92},
                                   is_attachment_point_types=['Remington 12 Ga Choke', ],
                                   optic_properties={'target_acquisition_ap': 0.95,
                                                     'ap_distance_cost_modifier': 1.2,
                                                     'spread_modifier': 1.1, },
...
r870_barrel_shorty = Item(
    ...
    usable_properties=GunComponent(part_type='Model 870 Barrel',
                                   incompatibilities=(("Iron Sight",),),
                                   velocity_modifier={'12 Guage': 1.0, 'single projectile': 0.62, 'buckshot': 0.77},
                                   is_attachment_point_types=['Remington 12 Ga Choke', ],
