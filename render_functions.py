...
def render_all(con, entities, fov_map, fov_recompute, game_map, screen_width, screen_height):
...
def draw_entity(con, entity, fov_map):
    if libtcod.map_is_in_fov(fov_map, entity.x, entity.y):
        ...
        libtcod.console_put_char(con, entity.x, entity.y, entity.char, entity.bg_colour)
